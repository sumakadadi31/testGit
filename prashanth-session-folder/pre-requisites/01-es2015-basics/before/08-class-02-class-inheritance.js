 ...
 */
class Employee2 extends Person2 { /* Step 2.2 */
...
let mary = new Employee2( 'Mary', 28, 'Web developer', 'IT' );
console.log( mary.getAge() ); // using the inherited getAge()
mary.celebrateBirthday(); // using the overriden celebrateBirthday()
console.log( mary.getAge() ); // age is now 29